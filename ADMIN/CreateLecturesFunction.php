...
<div class="col-sm-9 mt-5">
    ...
    <table class="table">
        ...
        <?php  while($row=$result->fetch_assoc()){ 
            echo '<tr>';
                echo '<th class="text-dark fw-bolder" scope="row">'.$row['lecture_id'].'</th>';
                echo '<td class="text-dark fw-bolder">'.$row['lecture_name'].'</td>';
                echo '<td class="text-dark fw-bolder">'.$row['lecture_design'].'</td>';
                echo '<td>';
                echo '
